...
route_instructions_6.onSwipeLeft (event, layer) ->
	flow.showNext(route_instructions_7)

route_instructions_6.onSwipeRight (event, layer) ->
	flow.showNext(route_instructions_5)

route_instructions_7.onSwipeLeft (event, layer) ->
	flow.showNext(route_instructions_8)

route_instructions_7.onSwipeRight (event, layer) ->
	flow.showNext(route_instructions_6)

route_instructions_8.onSwipeLeft (event, layer) ->
	flow.showNext(route_instructions_10)

current_location_close.onClick (event, layer) ->
	flow.showNext(route_instructions_8)

route_instructions_8.onSwipeRight (event, layer) ->
	flow.showNext(route_instructions_6)



###current_location_button_1.onClick (event, layer) ->
	print(flow.current)
	flow.showNext(route_instructions_7)

current_location_button_2.onClick (event, layer) ->
	print(flow.current)
	flow.showNext(route_instructions_7)

current_location_button_3.onClick (event, layer) ->
	#print(flow.current)
	flow.showNext(route_instructions_7)

current_location_button_4.onClick (event, layer) ->
	print(flow.current)
	flow.showNext(route_instructions_7)

current_location_button_5.onClick (event, layer) ->
	print(flow.current)
	flow.showNext(route_instructions_7)
