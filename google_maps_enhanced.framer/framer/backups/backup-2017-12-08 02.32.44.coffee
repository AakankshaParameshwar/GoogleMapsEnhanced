...
route_instructions_3.onClick (event, layer) ->
	flow.showNext(route_instructions_4)

route_instructions_4.onClick (event, layer) ->
	flow.showNext(route_instructions_5)
		
route_instructions_5.onClick (event, layer) ->
	flow.showNext(route_instructions_6)
	
route_instructions_6.onClick (event, layer) ->
	flow.showNext(route_instructions_7)

route_instructions_7.onClick (event, layer) ->
	flow.showNext(route_instructions_5)
